...
- M10 cluster tools: complete through its acceptance boundary. Singleton and
  ...
  commands at remote delivery adapters.
...
- M12 examples, migration, and documentation: substantial implementation.
  ...
  registry/gossip, delivery, and remote wire APIs. The remote ping-pong example
  and compile-tested serialization docs now exercise the format-neutral
  closure registration path. The
