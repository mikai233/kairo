...
- M4 remoting: complete through the composed runtime boundary. One
  ...
  delivery, settings, and canonical-address boundary now documents its complete
  public surface and denies missing documentation module by module. Cluster and
  other extension adoption proceeds in Phases 3 and 4.
