...
fn remote_boundary_modules_deny_missing_docs() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let documented_modules = [
        ...
        "kairo-next/crates/kairo-remote/src/remote_watch.rs",
        "kairo-next/crates/kairo-remote/src/remote_watch_actor.rs",
        "kairo-next/crates/kairo-remote/src/remote_watch_effects.rs",
        "kairo-next/crates/kairo-remote/src/remote_watch_inbound.rs",
        "kairo-next/crates/kairo-remote/src/remote_watch_system_inbound.rs",
...
fn cluster_documented_modules_deny_missing_docs() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let documented_modules = [
        ...
        "kairo-next/crates/kairo-cluster/src/event_publisher.rs",
        "kairo-next/crates/kairo-cluster/src/event_publisher/subscription.rs",
        "kairo-next/crates/kairo-cluster/src/extension.rs",
        "kairo-next/crates/kairo-cluster/src/failure_detector.rs",
        "kairo-next/crates/kairo-cluster/src/gossip.rs",
        "kairo-next/crates/kairo-cluster/src/gossip_process.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_actor.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_connector.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_remote/error.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_remote/mod.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_remote/outbound.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_remote/paths.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_remote/receiver_inbound.rs",
        "kairo-next/crates/kairo-cluster/src/heartbeat_remote/response_inbound.rs",
        "kairo-next/crates/kairo-cluster/src/init_join_responder.rs",
        ...
        "kairo-next/crates/kairo-cluster/src/remote_tcp.rs",
...
#[test]
fn distributed_data_documented_modules_deny_missing_docs() -> Result<(), Box<dyn std::error::Error>>
{
    let repo_root = repo_root()?;
    let documented_modules = [
        "kairo-next/crates/kairo-distributed-data/src/aggregation.rs",
        "kairo-next/crates/kairo-distributed-data/src/aggregation_actor.rs",
        "kairo-next/crates/kairo-distributed-data/src/aggregation_operation.rs",
        ...
        "kairo-next/crates/kairo-distributed-data/src/cluster_connector_timing.rs",
        "kairo-next/crates/kairo-distributed-data/src/cluster_routes.rs",
        "kairo-next/crates/kairo-distributed-data/src/cluster_subscription.rs",
        ...
        "kairo-next/crates/kairo-distributed-data/src/delta_transport.rs",
        ...
        "kairo-next/crates/kairo-distributed-data/src/gossip.rs",
        "kairo-next/crates/kairo-distributed-data/src/gossip_transport.rs",
        ...
        "kairo-next/crates/kairo-distributed-data/src/ormap.rs",
        "kairo-next/crates/kairo-distributed-data/src/orset.rs",
        "kairo-next/crates/kairo-distributed-data/src/pncounter.rs",
        "kairo-next/crates/kairo-distributed-data/src/pruning.rs",
        "kairo-next/crates/kairo-distributed-data/src/protocol.rs",
        "kairo-next/crates/kairo-distributed-data/src/read_write_receive.rs",
        "kairo-next/crates/kairo-distributed-data/src/remote_association.rs",
        "kairo-next/crates/kairo-distributed-data/src/remote_association_inbound.rs",
        "kairo-next/crates/kairo-distributed-data/src/remote_envelope.rs",
...
fn cluster_tools_documented_modules_deny_missing_docs() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let documented_modules = [
        ...
        "kairo-next/crates/kairo-cluster-tools/src/pubsub/mediator.rs",
        ...
        "kairo-next/crates/kairo-cluster-tools/src/remote_tcp.rs",
        "kairo-next/crates/kairo-cluster-tools/src/singleton/actor.rs",
        "kairo-next/crates/kairo-cluster-tools/src/singleton/local_manager.rs",
        "kairo-next/crates/kairo-cluster-tools/src/singleton/manager.rs",
...
fn sharding_documented_modules_deny_missing_docs() -> Result<(), Box<dyn std::error::Error>> {
    let repo_root = repo_root()?;
    let documented_modules = [
        "kairo-next/crates/kairo-cluster-sharding/src/lib.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/allocation.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/bootstrap.rs",
        ...
        "kairo-next/crates/kairo-cluster-sharding/src/coordinator_discovery.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/coordinator_remote_home.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/coordinator_remote_regions.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/coordinator_remote_registration.rs",
        ...
        "kairo-next/crates/kairo-cluster-sharding/src/handoff_transport.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/handoff_worker.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/protocol.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/remember.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/remember_actor.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/remember_ddata.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/remember_shard_ddata.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/region_actor.rs",
        ...
        "kairo-next/crates/kairo-cluster-sharding/src/region_remote/mod.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/region_remote/outbound.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/region_remote/control/inbound.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/region_remote/control/mod.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/region_remote/control/outbound.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/region_remote/control/reply.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/region_remote/control/target.rs",
        ...
        "kairo-next/crates/kairo-cluster-sharding/src/shard_actor.rs",
        "kairo-next/crates/kairo-cluster-sharding/src/shard_runtime.rs",
