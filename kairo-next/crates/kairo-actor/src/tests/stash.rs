...
fn stop_drains_stashed_messages_to_dead_letters() {
    ...
    assert_actor_stop_drains_stashed_messages_to_dead_letters(&system, actor);
}

#[test]
fn system_actor_stop_drains_stashed_messages_to_dead_letters() {
    let system = ActorSystem::builder("test").build().unwrap();
    let actor = system
        .spawn_system(
            "system-stash",
...
fn assert_actor_stop_drains_stashed_messages_to_dead_letters(
    system: &ActorSystem,
